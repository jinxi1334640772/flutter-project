...
class _AccountSecurityState extends State<AccountSecurity> {
  ...
  Widget topTipsWidget(){
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Text("请设置登陆密码", style: TextStyle(fontSize: 22.sp),),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: 150.w,
            child: Text("旧密码",style: TextStyle(fontSize: 26.sp, color: const Color(0xff737A83)),),
          ),
          SizedBox(
            width: 530.w,
            child: Row(
              children: [
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: "请输入旧密码",
                      hintStyle: TextStyle(fontSize: 26.sp, color: const Color(0xff737A83)),
                ...
                IconButton(
                    iconSize: 30.w,
                    icon: Icon(Icons.remove_red_eye,color: oldPasswordEyeColor,),
                    onPressed: () {
                      setState(() {
                        oldPasswordEyeColor = oldPasswordObscure ? Colors.blue : Colors.grey;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: 150.w,
            child: Text("新密码",style: TextStyle(fontSize: 26.sp, color: const Color(0xff737A83)),),
          ),
          SizedBox(
            width: 530.w,
            child: Row(
              children: [
                ...
                IconButton(
                    iconSize: 30.w,
                    icon: Icon(Icons.remove_red_eye,color: newPasswordEyeColor,),
                    onPressed: () {
                      setState(() {
                        newPasswordEyeColor = newPasswordObscure ? Colors.blue : Colors.grey;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: 150.w,
            child: Text("确认密码",style: TextStyle(fontSize: 26.sp, color: const Color(0xff737A83)),),
          ),
          SizedBox(
            width: 530.w,
            child: Row(
              children: [
                ...
                IconButton(
                    iconSize: 30.w,
                    icon: Icon(Icons.remove_red_eye,color: renewPasswordEyeColor,),
                    onPressed: () {
                      setState(() {
                        renewPasswordEyeColor = renewPasswordObscure ? Colors.blue : Colors.grey;
  ...
  Widget bottomTipsWidget(){
    return Container(
      padding: EdgeInsets.only(left: 40.w,top: 20.w,),
      child: Text("密码必须是8~16位的数字、字符组合（不能是纯数字）", style: TextStyle(fontSize: 22.sp),),
    );
  }
