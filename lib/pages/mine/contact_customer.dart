...
class _ContactCustomerState extends State<ContactCustomer> {
  ...
  Widget topPicture(){
    return Container(
      ...
      height: 250.w,
      child: Image.network("http://www.itying.com/images/flutter/7.png",fit: BoxFit.fill,),
    );
  }
  ...
  /// 官方微信
  Widget weixin(){
    return CommonWidget.listTileWithMine(title: "官方微信", desc: "识别二维码，关注官方微信",leadingBackgroundColor: Colors.white, leading: const Icon(Icons.wechat_outlined, color: Color.fromRGBO(54, 201, 86, 1),), callBack: (){
      print("添加官方微信");
    });
  }
