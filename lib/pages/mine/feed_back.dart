...
class _FeedBackState extends State<FeedBack> {
  ...
  Widget questionsCommentsWidget(){
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Text("问题和意见", style: TextStyle(color: const Color.fromRGBO(48, 49, 51, 1), fontSize: 26.sp),),
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(color: const Color.fromRGBO(150, 150, 150, 1), fontSize: 24.sp),
            ),
            style: TextStyle(color: const Color.fromRGBO(48, 49, 51, 1), fontSize: 26.sp),
            inputFormatters: [
  ...
  Widget contactInformationWidget(){
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Text("联系方式（手机、邮箱、QQ号码）", style: TextStyle(color: const Color.fromRGBO(48, 49, 51, 1), fontSize: 26.sp),),
          TextField(
  ...
  void onSubmit(BuildContext context){
    ...
    /// 这里需要提交到后台
    print("questionText: $questionText, contactText: ${contactController.text}");
