...
class _UserDetailState extends State<UserDetail> {
  ...
  /// 头像
  Widget avatarWidget(){
    return CommonWidget.simpleWidgetWithUserDetail("头像", value: userModel.avatar, isImage: true, callBack: (){
      print("更换头像");
  ...
  Widget deptNameWidget(){
    return CommonWidget.simpleWidgetWithUserDetail("部门名称", value: userModel.deptName);
  }

  /// 手机号
  Widget phoneWidget(){
    return CommonWidget.simpleWidgetWithUserDetail("手机", value: userModel.phone);
  }

  /// 邮箱
  Widget emailWidget(){
    return CommonWidget.simpleWidgetWithUserDetail("邮箱", value: userModel.email);
  }
                ...
                InkWell(
                  ...
                  onTap: () async {
                    ...
                    if(StringUtil.isNotEmpty(pickedFile)){
                      ...
                      String name = imageFile.path.substring(imageFile.path.lastIndexOf("/") + 1, imageFile.path.length);
                      print("name:$name");
                    }
                  },
                ),
